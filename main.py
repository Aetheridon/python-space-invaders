...
class SpaceInvader(arcade.Window):
    ...
    def start_new_game(self):
        #TODO: make this function basically add to the level counter and restart the game, call in the check_to_move_to_next_lvl function
        self.level += 1

    def check_to_move_to_next_lvl(self): #TODO: level get stuck in an inf loop of +1, fix!
        enemy_death_count = 0
        for enemy in enemy_objects:
